...
## Subproblem 4.
We wish to find an analytic formula for $f_{Z_i, \, U_i}(z_i, u_i \mid \lambda_0, \lambda_1)$. We separate the computation for cases when $u_i = 1$ and $u_i=2$, $i=1,\ldots, n$. The CDF is found by
\begin{align*}
...
\end{align*}
which we differentiate with respect to $z_i$ giving the PDF
$$
