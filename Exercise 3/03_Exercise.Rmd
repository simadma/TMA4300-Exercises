...
plot(1:TT, x, xlab = "t", ylab = "x", type = "l")
lines(c(TT-2, TT+2), rep(quantile(x_101_LS, 0.025), 2), type = "l", col = "red")
lines(c(TT-2, TT+2), rep(quantile(x_101_LS, 0.975), 2), type = "l", col = "red")
lines(c(TT-2, TT+2), rep(quantile(x_101_LA, 0.025), 2), type = "l", col = "blue")
lines(c(TT-2, TT+2), rep(quantile(x_101_LA, 0.975), 2), type = "l", col = "blue")
...
## Subproblem 4.
We wish to find an analytic formula for $f_{Z_i, \, U_i}(z_i, u_i \mid \lambda_0, \lambda_1)$. The CDF is found by
\begin{align*}
...
\end{align*}
We separate the computation for cases when $u_i = 1$ and $u_i=2$, $i=1,\ldots, n$. For $u_i=0$, differentiating the CDF with respect to $z_i$ gives the PDF
$$
