...
We then implement the EM-algorithm as follows.
...
Since we see a higher proportion of $u=1$, we expect $y$ to have a lower mean than what $[z\mid u=0]$ shows.
We guess that $\E[X]$ lies in the neighborhood of 0.4, and that $\E[Y]$ lies in the neighborhood of 0.1, giving the initial guess $(\lambda_0^{(0)}, \lambda_1^{(0)}) = (1/0.4, 1/0.1) = (2.5, 10)$.


```{r em-convergence, fig.align='center', fig.width=5, fig.height=3, fig.cap="caption..."}
EM_result <- EM(z, u, c(2.5, 10), tol = 1e-10)
EM_result$lambda
