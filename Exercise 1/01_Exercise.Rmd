...
Here we wish to estimate $\mu$ as
$$
  \hat{\mu}_\mathrm{IS} = \frac{1}{n} \sum_{i=1}^n \Theta_i \frac{f(\Theta_i \mid \bfy)}{g(\Theta_i \mid \bfy)},
$$
where in this case $\Theta_1, \dots, \Theta_n \sim \Betadist(1, 5)$.
